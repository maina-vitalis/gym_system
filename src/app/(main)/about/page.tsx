          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="text-center mb-16">
              <h2 className="text-3xl md:text-4xl font-bold mb-8">
                About{" "}
                <span className="text-yellow-500">Tumaini Fitness Centre</span>
              </h2>
              <div className="max-w-4xl mx-auto space-y-6">
                <p className="text-lg md:text-xl text-gray-600 dark:text-gray-300 leading-relaxed">
                  Tumaini Fitness Centre (
                  <span className="text-yellow-500 font-semibold">TFC</span>) is
                  a modern fitness gym located in Nairobi, Kenya, at Kastemil
                  Business Centre, Kasarani Constituency. We offer comprehensive
                  fitness services that help our clients get in shape by losing
                  excess fat, building muscles, and promoting a healthy balanced
                  lifestyle through expert nutrition training.
                </p>
                <p className="text-lg md:text-xl text-gray-600 dark:text-gray-300 leading-relaxed">
                  Our services are{" "}
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
                ...
                <div className="group bg-gradient-to-br from-yellow-50 to-yellow-100 dark:from-yellow-900/20 dark:to-yellow-800/20 p-8 rounded-2xl hover:shadow-lg transition-all duration-300">
                  ...
                  <p className="text-gray-700 dark:text-gray-300 text-center leading-relaxed">
                    ...
                    your fitness journey and achieve optimal health and wellness
                    goals.
                  </p>
                </div>
              </div>
                ...
                <div className="space-y-6 text-gray-700 dark:text-gray-300">
                  <div>
                    ...
                    <p className="text-sm leading-relaxed">
                      ...
                      aerobics, and Zumba, and can visit the gym at any time of
                      day.
                    </p>
                  </div>
                  <div>
            ...
            <div className="text-center bg-gradient-to-r from-orange-500/10 via-yellow-500/10 to-red-500/10 dark:from-orange-900/20 dark:via-yellow-900/20 dark:to-red-900/20 p-12 rounded-3xl mb-20 border border-yellow-200 dark:border-yellow-800">
              ...
              <div className="max-w-4xl mx-auto space-y-6">
                <p className="text-lg text-gray-600 dark:text-gray-300 leading-relaxed">
                  ...
                  <span className="text-yellow-500 font-semibold">Karate</span>,{" "}
                  <span className="text-yellow-500 font-semibold">
                    Dance Training
                  </span>
                  ,{" "}
